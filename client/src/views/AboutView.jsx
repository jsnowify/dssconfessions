  ...
  <div className="max-w-3xl mx-auto px-6 animate-fade-in space-y-12 pb-20">
    ...
    <section className="bg-white border-2 border-black p-8 rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
      ...
      <p className="text-zinc-600 font-medium leading-relaxed">
        Hi, I'm{" "}
        <a
          href="https://snowi-swjc.vercel.app/"
          target="_blank"
          rel="noopener noreferrer"
          className="text-black font-bold underline hover:text-rose-600 transition-colors"
        >
          Joshua "Snowi" Cambronero
        </a>
        , a 4th-year BSIT student. I built this for fun and to practice software
        engineering skills.
      </p>
    </section>
    <section className="bg-zinc-50 border-2 border-black p-8 rounded-2xl">
      ...
      <p className="text-zinc-600 font-medium leading-relaxed">
        People often leave things unsaid. This project gives those words a place
        to go, paired with the songs that carry them. It's inspired by{" "}
        <span className="text-black font-bold underline">SendTheSong</span>.
      </p>
    </section>
    <section className="bg-white border-2 border-black p-8 rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
      ...
      <p className="text-zinc-600 font-medium leading-relaxed">
        ...
        absolute anonymity. No IP addresses, browser fingerprints, or personal
        metadata are tracked. What you say here remains between you, the music,
        and the void.
      </p>
    </section>
  </div>
